...
<head>
    ...
    <title>Employee Rail - Home</title>
            ...
            <table class="table table-dark table-striped text-light">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <a class="btn btn-danger btn-sm" href="3_add_delay.php" role="button">Add Delay</a> </td>
                    </tr>
                    <?php
                    } ?>
                </tbody>
                <tbody><tr>
                    <td colspan="7"><a class="btn btn-primary" href="3_add_train.php" role="button">Add Another Train</a></td>
                    </tr></tbody>
                </table>
        </div>

...
<head>
    ...
    <title>Bhartiya Rail - Enquiry</title>
...
<body class="bg-dark text-white">
    <div className="poora">
            ...
            <div class="container-fluid ">
              ...
              <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="1_enquiry.php">Enquiry</a>
                  </li>
                  <li class="nav-item">
     ...
     <div class="containaa text-white" style="background-color: rgb(69, 62, 62);">
        <div class="p-3 headin">
            <h1 style="margin: auto; width:50%; padding: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/></svg>  Enquiry  <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" class="bi bi-question-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/></svg></h1>
            <p>Check if Train is availaible to your Destination</p>
        </div>
        ...
        <form action="1_enquiry.php" method="post" class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="email" class="form-control" name="Password" id="inputPassword4">
            </div>
            <div class="col-md-12">
                <label for="frome" class="form-label">From</label>
                <select id="inputState" class="form-select" name="frome">
              ...
              <div class="col-md-12">
                ...
                <select id="inputState" class="form-select" name="toe">
                  <option selected>Choose</option>
                  <option selected>Choose</option>
                  <option>Delhi</option>
                  <option>Mumbai</option>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!$conn){
        ...
        $sql = "SELECT * FROM `train` WHERE `Frome` = '$from' AND `Toe` = '$to'";
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      '<td>'.$row['DateTime'].'</td>'.
      '<td>'.$row['Delay'].'</td>
      <td><a class="btn btn-danger" href="1_availaibility.php" role="button">Get Tic</a></td>
      </tr>';
    }
    echo'</tbody>
    </table>';
